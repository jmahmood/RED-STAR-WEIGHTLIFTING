...
struct PlanV03: Decodable {
    ...
    struct StraightSegment: Decodable {
    ...
    struct SchemeSegment: Decodable {
    ...
    struct SupersetSegment: Decodable {
    ...
    init(planName: String, unit: WeightUnit, exerciseNames: [String: String], altGroups: [String: [String]], days: [Day], scheduleOrder: [String]) {
...
extension PlanV03 {
    static var preview: PlanV03 {
        let segment = Segment.straight(
            StraightSegment(
                exerciseCode: "PRESS.DB.FLAT",
                altGroup: "GROUP_CHEST_PRESS",
                sets: 3,
                reps: RepetitionRange(min: 8, max: 10, text: nil),
                restSec: 120,
                rpe: 8.0,
                intensifier: nil,
                timeSec: nil,
        ...
        let day = Day(label: "Preview Day", segments: [segment])
        return PlanV03(
            planName: "Preview Plan",
            unit: .pounds,
            exerciseNames: ["PRESS.DB.FLAT": "DB Press"],
            altGroups: ["GROUP_CHEST_PRESS": ["PRESS.DB.FLAT", "BP.MACH.CHEST"]],
            days: [day],
            scheduleOrder: ["Preview Day"]
        )
    }
}
